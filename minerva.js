...
function promiseCourses(selection) {
  return function(response) {
    ...
    function formUrlEncode(options) {
      ...
      var request_body = [
        "term_in=" + (options.year || '2017') + season,
        "&sel_subj=dummy",
        "&SEL_DAY=dummy",
        "&SEL_SCHD=dummy",
        "&SEL_INSM=dummy",
